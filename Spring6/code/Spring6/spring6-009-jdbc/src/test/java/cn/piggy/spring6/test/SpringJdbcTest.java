...
public class SpringJdbcTest {
    ...
    public void testBatchUpdate() {
        ...
        // 准备数据
        Object[] obj1 = {"小花1", 19, 4};
        Object[] obj2 = {"小白2", 29, 5};
        Object[] obj3 = {"小刘3", 26, 6};
    ...
    public void testUpdate() {
        ...
        int count = jdbcTemplate.update(sql, "张三丰", 28, 1);
        System.out.println(count);
    }
    ...
    public void testInsert() {
        ...
        // 注意：在jdbcTemplate中，只要是insert, delete, update语句都是调用的update()方法
